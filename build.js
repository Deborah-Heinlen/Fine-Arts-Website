...
// product/index.html is the single source of truth for the product
// page design.  We inject product-specific SEO data into it.
...
// Removes all previously generated {id}/ subfolders.
// Leaves product/index.html untouched.
...
Object.values(PRODUCTS).forEach(function(product) {
  ...
  //    This tells the page JS which product to render without ?id=
  const productIdScript = '  <script>window.__PRODUCT_ID__ = \'' + id + '\';</script>\n</head>';
  page = page.replace('</head>', productIdScript);

  // 9. Add a note at the top that this is auto-generated
  page = page.replace(
